...
export default function Products() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/ecommerce/phone-list")
      .then((res) => {
  ...
  function handleSave() {
    ...
    if (editId) {
      axios
        .put(`http://localhost:5000/api/ecommerce/update-one/${editId}`, payload)
        .then(() => {
          setProducts((prev) =>
      ...
      axios
        .post("http://localhost:5000/api/ecommerce/add-one", payload)
        .then((res) => {
  ...
  function handleDelete(id) {
    if (window.confirm("Are you sure you want to delete this product?")) {
      axios
        .delete(`http://localhost:5000/api/ecommerce/delete-one/${id}`)
  ...
  function toggleStatus(id) {
    axios
      .put(`http://localhost:5000/api/ecommerce/toggle-status/${id}`)
      .then((res) => {

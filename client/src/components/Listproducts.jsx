...
const Listproducts = () => {
  ...
  const fetchProducts = async () => {
    try {
      const res = await axios.get(`https://mobile-e-commerce-production.up.railway.app/api/ecommerce/product/${model}`);
  ...
  const addToCart = (item) => {
    ...
    axios
      .post("https://mobile-e-commerce-production.up.railway.app/api/auth/add-to-cart", { productId: item._id }, {
